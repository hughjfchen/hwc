let
  ...
  #nixpkgsSrc = if haskellNix.pkgs.stdenv.hostPlatform.isDarwin then sources.nixpkgs-darwin else haskellNix.sources.nixpkgs-2211;
...
rec {
  ...
  hwc-exe = hwc.hwc.components.exes.hwc;
  hwc-test = hwc.hwc.components.tests.hwc-test;
